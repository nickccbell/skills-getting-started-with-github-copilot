document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear loading message and repopulate form options
        ...
        const participantItems = details.participants.length
          ? details.participants.map((email) => `
              <li>
                ...
                <button class="remove-participant" data-activity="${name}" data-email="${email}" aria-label="Remove participant">&times;</button>
              </li>
            `).join("")
